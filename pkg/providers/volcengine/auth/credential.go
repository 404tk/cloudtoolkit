...
// Credential is the provider-local Volcengine AK/SK shape used by the
// lightweight OpenAPI client.
...
func (c Credential) Validate() error {
	...
	case strings.TrimSpace(c.AccessKey) == "":
		return errors.New("volcengine credential: empty access key")
	case strings.TrimSpace(c.SecretKey) == "":
		return errors.New("volcengine credential: empty secret key")
	default:
		return nil
	}
}
